...
Public Class FrmCuentas_cobrar
    Private Sub FrmCuentas_cobrar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub MOSTRAR()
        Dim cmd As New SqlClient.SqlCommand("Select *  FROM TBL_CuentasACobrar where cedula='" & TextBox3.Text & "'", conecion)
        Dim DA As New SqlDataAdapter(cmd)
        Dim DR As SqlClient.SqlDataReader
        Dim ds As New DataSet
        DA.Fill(ds, "TBL_CuentasACobrar")
        DataGridView1.DataSource = ds.Tables("TBL_CuentasACobrar")
        conecion.Open()
        ...
        Else
            MsgBox("ESTA CUENTA POR COBRAR NO ESTA REGISTRADA EN EL SISTEMA ")
        End If
        conecion.Close()
    End Sub
    Sub nuevo()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim cmd As New SqlClient.SqlCommand("Insert Into TBL_CuentasACobrar (nombre,apellido,cedula,Descripcion,telefono,direccion,imagen)values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & MaskedTextBox1.Text & "','" & TextBox5.Text & "','" & imagen & "')", conecion)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim cmd As New SqlClient.SqlCommand("delete from TBL_CuentasACobrar Where cedula='" & TextBox3.Text & "'", conecion)
        If TextBox3.Text = "" Then
            MsgBox("DEBE INGRESAR LA CEDULA DEL DEUDOR PARA BORRAR EL REGISTRO")
        ...
        Else
            ...
            conecion.Close()
            nuevo()
            MsgBox("EL REGISTRO DEL DEUDOR SE HA ELIMINADO EXITOSAMENTE")
