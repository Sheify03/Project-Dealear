...
Public Class FrmVehiculos
    ...
    Sub MOSTRAR()
        Dim cmd As New SqlClient.SqlCommand("Select *  FROM TBL_Vehiculo where codigo='" & TextBox1.Text & "'", conecion)
        Dim DA As New SqlDataAdapter(cmd)
        Dim DR As SqlClient.SqlDataReader
        Dim ds As New DataSet
        DA.Fill(ds, "TBL_Vehiculo")
        DataGridView1.DataSource = ds.Tables("TBL_Vehiculo")
        conecion.Open()
        ...
        Else
            MsgBox("ESTE PRODUCTO NO ESTA REGISTRADO EN EL SISTEMA ")
        End If
        conecion.Close()
    End Sub
    Sub nuevo()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim cmd As New SqlClient.SqlCommand("Insert Into TBL_Vehiculo (codigo,articulo,marca,precio,Descripcion,imagen_Vehiculo)values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & imagen & "')", conecion)
        If (TextBox1.Text = "") Or (TextBox2.Text = "") Or (TextBox3.Text = "") Or (TextBox4.Text = "") Or (TextBox5.Text = "") Or (imagen = "") Then
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim cmd As New SqlClient.SqlCommand("delete from TBL_Vehiculos Where codigo='" & TextBox1.Text & "'", conecion)
        If TextBox1.Text = "" Then
            MsgBox("DEBE INGRESAR EL CODIGO DEL PRODUCTO PARA BORRAR EL REGISTRO")
        ...
        Else
            ...
            conecion.Close()
            nuevo()
            MsgBox("EL REGISTRO DEL PRODUCTO SE HA ELIMINADO EXITOSAMENTE")
