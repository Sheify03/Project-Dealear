...
Public Class FrmClientes
    ...
    Sub mostrar()
        Dim cmd As New SqlClient.SqlCommand("Select *  FROM TBL_Cliente where cedula='" & TextBox3.Text & "'", conecion)
        Dim DA As New SqlDataAdapter(cmd)
        Dim DR As SqlClient.SqlDataReader
        Dim ds As New DataSet
        DA.Fill(ds, "TBL_Cliente")
        DataGridView1.DataSource = ds.Tables("TBL_Cliente")
        conecion.Open()
        ...
        If DR.Read Then
            ...
            TextBox1.Focus()
        Else
            MsgBox("Este Cliente no esta en el sistema ")
        End If
        conecion.Close()
    End Sub
    Sub nuevo()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim cmd As New SqlClient.SqlCommand("Insert Into TBL_Cliente (nombre,apellido,cedula,telefono,direccion,imagen)values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & MaskedTextBox1.Text & "','" & TextBox4.Text & "','" & imagen & "')", conecion)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim cmd As New SqlClient.SqlCommand(" delete from TBL_Cliente where cedula='" & TextBox3.Text & "'", conecion)
        If TextBox3.Text = "" Then
            MsgBox("DEBE INGRESAR LA CEDULA DEL CLIENTE PARA BORRAR EL REGISTRO")
        ...
        Else
            ...
            conecion.Close()
            nuevo()
            MsgBox("EL REGISTRO DEL CLIENTE SE HA ELIMINADO EXITOSAMENTE")
